...
export default {
  ...
  about: {
    ...
    intro: "Movie Tracker помогает держать все фильмы и сериалы в одном месте — искать, сохранять, оценивать и отслеживать прогресс просмотра. Интерфейс на русском и английском, можно установить как приложение на телефон.",
